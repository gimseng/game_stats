...
SAVE_FILE_PATH = '/Users/gng/Google Drive/my own projects/gaming/game_stats/data/user/'
...
user_url_df = pd.DataFrame(list_user_url)
user_url_df.to_csv(SAVE_FILE_PATH+'list_user_url.csv',
                   sep=',', header=None, index=None)
user_url_df.to_pickle(SAVE_FILE_PATH+'list_user_url.pkl')
